...
| :--- | :--- | :--- | :--- |
| **`crm_nexus_architect`** | ARCHITECTUM | Autarkie, MVC, Schema, Versionierung (`CRM_VERSION = '2.18.1'`) | [ARCHITECT.md](file:///c:/laragon/www/x-sieben/wp-content/themes/sieben/inc/core/crm/agents/ARCHITECT.md) |
...
- **`crm-admin.php`**: Hauptseite, Menüeintrag, Asset-Fallback-Registration, Versionsanzeige (`CRM_VERSION = '2.18.1'`).
