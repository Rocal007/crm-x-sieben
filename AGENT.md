...
- **`crm-admin.php`**: Hauptseite, Menüeintrag, Asset-Fallback-Registration, Versionsanzeige (`CRM_VERSION = '2.11.7'`).
- **`crm-settings.php`**: E-Mail-Editor, PDF-Editor mit 25 Standard-Bausteinen sowie integrierter asynchroner PDF-Live-Vorschau für alle 5 Dokumente (KB, TB, Diplom, Angebot, Rechnung).
